...
static ULONG packTable[] =
	...
	PACK_ENTRY(IDTA_TAGBASE, IDTA_Font, 			InstanceData, iobj_Font, 				PKCTRL_IPTR | PKCTRL_PACKUNPACK),
	...
	PACK_ENTRY(IDTA_TAGBASE, IDTA_FontHook, 		InstanceData, iobj_FontHook, 				PKCTRL_IPTR | PKCTRL_PACKUNPACK),
	PACK_ENTRY(IDTA_TAGBASE, IDTA_Fonthandle, 		InstanceData, iobj_Fonthandle, 				PKCTRL_IPTR | PKCTRL_PACKUNPACK),
