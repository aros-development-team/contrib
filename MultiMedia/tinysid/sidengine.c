...
enum { 
  adc, opand, asl, bcc, bcs, beq, bit, bmi, bne, bpl, brk, bvc, bvs, clc,
...
static int opcodes[256]= {
  ...
  jsr,opand,xxx,xxx,bit,opand,rol,xxx,plp,opand,rol,xxx,bit,opand,rol,xxx,
  bmi,opand,xxx,xxx,xxx,opand,rol,xxx,sec,opand,xxx,xxx,xxx,opand,rol,xxx,
